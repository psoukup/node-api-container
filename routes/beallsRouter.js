    ...
    if (queryString === 'Florida Gator Pants' || queryScope === 'All' || minMatch.substring(0,1) === '2') {
        ...
        var response = {
            ...
            "recordSetTotal": 1,
             ...
             "resourceId": "https://qa-api.inc.com/search/resources/store/10151/productview/bySearchTerm/" + searchTerm + "?pageNumber=1&pageSize=10&catalogId=12003",
